...
class Chart {
  ...
  constructor(canvasId: string, bars: Bar[]) {
    ...
    // Визначаємо масштабування для відображення
    // this.scaleY = this.height / this.getMaxPriceDiff(); // масштабування по Y, базоване на різниці цін
    // this.scaleX = 10; // Відстань між барами
    // ==============================
    // Масштабування і зміщення по X
